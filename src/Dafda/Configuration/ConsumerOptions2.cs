...
/// </summary>
public sealed class ConsumerOptions2
{
    // <summary>/ The <see cref="ConsumerConfigurationBuilder"/> used to build the final configuration for the consumer. </summary>
    internal readonly ConsumerConfigurationBuilder Builder;
    
    /// <summary>Constructor</summary>
    public ConsumerOptions2()
    {
        Builder = new ConsumerConfigurationBuilder();
    }
    /// <summary>
    ...
    {
        Builder.WithUnitOfWorkFactory(sp => (IHandlerUnitOfWorkFactory)ActivatorUtilities.CreateInstance(sp, typeof(T)));
    }
    ...
    {
        Builder.WithUnitOfWorkFactory(implementationFactory);
    }

    internal void WithConsumerScopeFactory(Func<IServiceProvider, IConsumerScopeFactory> consumerScopeFactory)
    {
        Builder.WithConsumerScopeFactory(consumerScopeFactory);
    }
    ...
    {
        Builder.WithIncomingMessageFactory(incomingMessageFactory);
    }
    ...
    {
        Builder.WithPoisonMessageHandling();
    }
    ...
    {
        Builder.WithMessageFilter(messageFilter);
    }
    ...
    {
        Builder.RegisterMessageHandler<TMessage, TMessageHandler>(topic, messageType);
    }
    ...
    {
        Builder.WithUnconfiguredMessageHandlingStrategy(sp => (IUnconfiguredMessageHandlingStrategy)ActivatorUtilities.CreateInstance(sp, typeof(T)));
    }
