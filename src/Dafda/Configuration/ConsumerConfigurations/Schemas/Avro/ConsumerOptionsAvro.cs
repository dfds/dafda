...
namespace Dafda.Configuration.ConsumerConfigurations.Schemas.Avro
{
    ...
    public sealed class ConsumerOptionsAvro<TKey, TValue> where TValue : ISpecificRecord
    {
        ...
        public void RegisterMessageResultHandler<TMessage, TMessageHandler>(string topic)
            where TMessageHandler : class, IMessageHandler<MessageResult<TKey, TValue>> where TMessage : MessageResult<TKey, TValue>
        {
